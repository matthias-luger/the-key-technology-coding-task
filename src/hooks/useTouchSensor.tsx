/*
    IMPORTANT: 
    The content of this file was mostly provided by a user on GitHub who himself has most of the code
    an older release of the react-beautiful-dnd package. This version of the useTouchSensor function fixes an issue
    with the drag'n'drop functionality on touch devices
    https://github.com/atlassian/react-beautiful-dnd/issues/2111#issuecomment-1487015875
*/
...
const supportedPageVisibilityEventName: string = ((): string => {
    ...
    const supported = find(candidates, (eventName: string): boolean => `on${eventName}` in document)
    ...
    return [
        ...
        // https://developer.apple.com/library/content/documentation/AppleApplications/Conceptual/SafariJSProgTopics/RespondingtoForceTouchEventsfromJavaScript.html
        {
            ...
            fn: (event: Event) => {
                ...
                const touch: TouchWithForce = (event as TouchEvent).touches[0] as TouchWithForce
...
export default function useTouchSensor(api: SensorAPI) {
    ...
    const startCaptureBinding = useMemo(
        () => ({
            ...
            fn: function onTouchStart(event: Event) {
                ...
                const touch: Touch = (event as TouchEvent).touches[0]
